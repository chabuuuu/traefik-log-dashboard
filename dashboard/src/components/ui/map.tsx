...
const LeafletCircle = Circle
const LeafletCircleMarker = CircleMarker
const LeafletPolyline = Polyline
const LeafletPolygon = Polygon
const LeafletRectangle = Rectangle
const LeafletLayerGroup = LayerGroup
const LeafletFeatureGroup = FeatureGroup
const LeafletMarkerClusterGroup = MarkerClusterGroup as ComponentType<MarkerClusterGroupProps>
